...
addon_info = AddonInfo(
	...
	addon_url="https://github.com/kefaslungu/CustomLabels",
	# URL for the add-on repository where the source code can be found
	addon_sourceURL="https://github.com/kefaslungu/CustomLabels",
	...
	addon_licenseURL="http://www.gnu.org/licenses/gpl-2.0.html",
)
...
pythonSources: list[str] = [
	"addon/globalPlugins/CustomLabels/*.py"
]
